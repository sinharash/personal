// below code is also same as the very bottom but this one namespace is input from
// action as well if developer sends it then use it otherwise
// fall to "default"
...
// this code is with catalogClient with 401 error
// // packages/backend/src/plugins/scaffolder/actions/enhancedEntityActions.ts
