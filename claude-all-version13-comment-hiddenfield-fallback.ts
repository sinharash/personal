...
export const EnhancedEntityPicker = ({
   ...
   * Comes from YAML: hiddenFieldName: "selectedGroupEntityName"
   * 
   * ⚠️ IMPORTANT: Developer should always provide this!
   * Default is generic but may not match actual hidden field name.
   */
  const hiddenFieldName = 
    uiSchema?.["ui:options"]?.hiddenFieldName ||
    "selectedEntityName"; // 👈 More generic default
